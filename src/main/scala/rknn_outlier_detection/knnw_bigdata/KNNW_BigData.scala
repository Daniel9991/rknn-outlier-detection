...
class KNNW_BigData(val k: Int, val p: Double) extends Serializable{
...
//        classData
    ...
    def fase2(lista: Broadcast[Array[(TuplaFase1)]], rdd: Dataset[TuplaFase1], spark: SparkSession): Dataset[TuplaFase1] = {
        ...
        val result = rdd.mapPartitions { iterator =>
            ...
            val r = lista.value.map { x =>
                val iter = arr.foldLeft(Array[Double]())((v1, v2) => insert(distanceds(x.valores.toArray, v2.valores.toArray, spark), v1, spark))
    ...
    def fase1(lista: Array[Tupla], spark: SparkSession): Iterator[TuplaFase1] = {
        ...
        val iter = lista.map { x =>
            ...
            l = lista.foldLeft(Array.empty[Double])((v1, v2) => insert(distanceds(x.valores, v2.valores, spark), v1, spark))
    ...
    def fase1Banco(lista: Array[TuplaBanco], spark: SparkSession): Iterator[TuplaFase1Banco] = {
        ...
        val iter = lista.map { x =>
            ...
            l = lista.foldLeft(l)((v1, v2) => insert(distancedsBanco2(x, v2, spark), v1, spark))
