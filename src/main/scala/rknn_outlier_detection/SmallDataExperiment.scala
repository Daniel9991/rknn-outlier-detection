...
//
//        runSmallDataExperiment()
//    }
//
//    def runSmallDataExperiment(): Unit ={
//        def instancesLoader(rawData: Array[Array[String]]): Array[Instance[Array[Double]]] = {
...
//        val smallDataCombinations: Array[(String, Boolean, String, Array[Array[String]] => Array[Instance[Array[Double]]], KNNSearchStrategy[Array[Double]], DetectionCriteria)] = Array(
//            ("datasets/iris-synthetic-2.csv", false, "Testing small data with exhaustive search and Antihub criteria", instancesLoader, new ExhaustiveSmallData[Array[Double]](), Antihub),
//            ("datasets/iris-synthetic-2.csv", false, "Testing small data with exhaustive search and AntihubRefined criteria", instancesLoader, new ExhaustiveSmallData[Array[Double]], new AntihubRefined(0.2, 0.3)),
